...
zipFile file,const char* filename,const zip_fileinfo* zipfi,
                                         const char* extrafield_local,uInt  size_extrafield_local,
                                         const char* extrafield_global,uInt  size_extrafield_global,
...
extern int ZEXPORT zipWriteInFileInZip ( zipFile file, const void* buf, uLong len)
//    zipFile file;
  //  const void* buf;
    //unsigned len;
{
