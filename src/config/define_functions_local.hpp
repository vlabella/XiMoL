...
/** \file 
    ...
    XIMOL_HEADER_DEFINE_FUNCTION(T1)
    ...
    $Id: define_functions_local.hpp,v 1.2 2005/05/13 00:05:24 vlabella Exp $
    $Log: define_functions_local.hpp,v $
...
#error You must define XIMOL_HEADER_DEFINE_FUNCTION(T1) before include this header
#endif 

XIMOL_HEADER_DEFINE_FUNCTION(std::string             )
XIMOL_HEADER_DEFINE_FUNCTION(std::string const       )
XIMOL_HEADER_DEFINE_FUNCTION(ximol::xstring          )
XIMOL_HEADER_DEFINE_FUNCTION(ximol::xstring const    )
XIMOL_HEADER_DEFINE_FUNCTION(char const *            )
XIMOL_HEADER_DEFINE_FUNCTION(ximol::xchar_t const *  )
