...
/** \file 
    ...
    XIMOL_HEADER_DEFINE_FUNCTION(T1,T3)
    ...
    $Id: define_functions_local_attributes.hpp,v 1.2 2005/05/13 00:05:24 vlabella Exp $
    $Log: define_functions_local_attributes.hpp,v $
...
#error You must define XIMOL_HEADER_DEFINE_FUNCTION(T1,T3) before include this header
#endif 

#define XIMOL_TEMP_CREATOR_1(type1)\
    XIMOL_HEADER_DEFINE_FUNCTION(type1, ximol::xml::attributes       )\
    XIMOL_HEADER_DEFINE_FUNCTION(type1, ximol::xml::attributes const )
